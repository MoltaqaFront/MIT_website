...
export default {
  ...
  methods:{
    async getData() {
    try {
      return await this.$axios.get(`api/terms-and-conditions`).then(response => {
        this.isLoading=true;
        this.terms_title = response.data.body.title;
        this.terms_content = response.data.body.content;
